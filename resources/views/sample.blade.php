...
<script>
    function validateForm() {
        ...
        if (address.trim() === "") {
            // alert("Bitte füllen Sie das Feld 'Verschicken nach' aus.");
            alert('{{__('messages.Bitte füllen Sie das Feld -Verschicken nach- aus.')}}');
            return false;
        }
                ...
                <li>
                    <form method="POST" action="{{ url('/shipped') }}">
                        ...
                        <li>
                            ...
                            <button type="submit" class="dropdown-item" onclick="return validateForm()">{{__('messages.Probe verschicken')}}
                                <input type="text"
