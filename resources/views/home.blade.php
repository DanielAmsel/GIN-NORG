                                                                                    ...
                                                                                    @for ($sample=1; $sample <= $sampleValue ; $sample++)
                                                                                        ...
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            @if ( $selecetedSample->value('pos_smpl') == $sample)
                                                                                                <button type="button" class="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Probe {{ $sample }} </button>
                                                                                                <ul class="dropdown-menu">
                                                                                                        <li><a class="dropdown-item" >{{ $selecetedSample->value('B_number') }}             </a></li>
                                                                                                        <li><a class="dropdown-item" >{{ $selecetedSample->value('responsible_person') }}   </a></li>
                                                                                                        <li><a class="dropdown-item" >{{ $selecetedSample->value('type_of_material') }}     </a></li>
                                                                                                                ...
                                                                                                                @csrf
                                                                                                                    <li >
                                                                                                                        <button type="submit" class="dropdown-item"> Probe verschicken
                                                                                                                            <input type="text" value="{{ $selecetedSample->value('id') }}"name="sample_id" hidden>
                                                                                                                        </button>
                                                                                                                    </li>
                                                                                                            </form>
                                                                                                        </li>
                                                                                            ...
                                                                                            @else
                                                                                                <button type="button" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Position {{ $sample }} </button>
                                                                                                <ul class="dropdown-menu">
                                                                                                    <form method="POST" action="{{ Url('newSamples/pos') }}" >
                                                                                                        @csrf
                                                                                                            <li >
