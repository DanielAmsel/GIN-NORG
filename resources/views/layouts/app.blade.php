...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                            @if (Auth::user()->role != 'physician' && Auth::user()->role != 'office')
                                                ...
                                                <a class="dropdown-item" href="{{ route('sample.import.form') }}">{{__('messages.CSV Import')}}</a>
                                            @endif
                                            <a class="dropdown-item" href="{{ route('logout') }}"
                                                onclick="event.preventDefault();
                                                                document.getElementById('logout-form').submit();">
    ...
    <footer class="text-center fixed-bottom">
        <div class="fixed-bottom text-center align-items-center" style="background-color: lightgray">
            <span class="me-5 text-muted">{{__('messages.Information zum ')}}
                <a href="/imprint">{{__('messages.Impressum ')}}
                </a>
                {{__('messages.und ')}}
                <a href="/privacy">{{__('messages.Datenschutz ')}}
                </a>
                {{__('messages.erhalten Sie über die angegebenen Links.')}}
            </span>
        </div>
    </footer>
